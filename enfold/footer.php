	...
	<?php   } //endif nofooterwidgets ?>
			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    ...
                    <h2>Teeme Teie vajadusest lähtuva pakkumise</h2>
                    <div class="row">
                        <a class="button" >Küsi projektimüügi pakkumist siit</a>
                    </div>
                </div>
				
			
			<div class="partner-logos"><div class="container"><h2 class="partners-headline">Meie koostööpartnerid</h2>	<?php echo do_shortcode(' [tc-logo-slider]'); ?></div></div>
